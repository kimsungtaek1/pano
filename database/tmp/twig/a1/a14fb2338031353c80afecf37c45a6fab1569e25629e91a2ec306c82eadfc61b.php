...
class __TwigTemplate_7605cfd0e7cd2339e7e2117c18a6a34e473aca004ab54e57f6708793dc1a0823 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Variables");
      ...
      ";
        ...
        ";
                    // line 26
                    if ((array_key_exists("page", $context) && (0 === twig_compare(($context["page"] ?? null), $context["current"])))) {
                        // line 27
                        echo "          <strong>";
...
";
    ...
    {
        return new Source("", "server/engines/show.twig", "/trenddevapp/www/database/templates/server/engines/show.twig");
    }
}
