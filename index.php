...
// 성공사례 (파노 성공사례) - 최신 10개
$success_sql = "SELECT * FROM news WHERE is_published = 1 AND category = '파노 성공사례' ORDER BY news_date DESC, created_at DESC LIMIT 10";
$success_list = $pdo->query($success_sql)->fetchAll();

// 언론보도 - 최신 10개
$press_sql = "SELECT * FROM news WHERE is_published = 1 AND category = '언론보도' ORDER BY news_date DESC, created_at DESC LIMIT 10";
